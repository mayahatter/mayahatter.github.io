...
var Froogaloop = function() {
    ...
    function t(t) {
        ...
        t.origin != c)
            return !1;
        var r, i, l = e.value, o = e.data, u = "" === u ? null : e.player_id, a = (r = n,
        (i = u) ? d[i][r] : d[r]), s = [];
        return !!a && (void 0 !== l && s.push(l),
        o && s.push(o),
        u && s.push(u),
    ...
    return (e.fn = e.prototype = {
        ...
        init: function(t) {
            ...
            this.element = t,
            c = function(t) {
                for (var e = t.split("/"), n = "", r = 0, i = e.length; r < i && r < 3; r++)
                    n += e[r],
                    r < 2 && (n += "/");
                return n
        ...
        addEvent: function(t, e) {
            ...
            var n = this.element
              , r = "" !== n.id ? n.id : null;
            return u(t, e, r),
            "ready" != t ? o("addEventListener", t, n) : "ready" == t && f && e.call(null, r),
            this
        },
    ...
    window.addEventListener ? window.addEventListener("message", t, !1) : window.attachEvent("onmessage", t, !1),
...
!function(T) {
    ...
    T.goodlayers_flexslider = function(p, e) {
        ...
        var t, v = m.vars.namespace, f = window.navigator && window.navigator.msPointerEnabled && window.MSGesture, g = ("ontouchstart"in window || f || window.DocumentTouch && document instanceof DocumentTouch) && m.vars.touch, r = "click touchend MSPointerUp keyup", o = "", h = "vertical" === m.vars.direction, y = m.vars.reverse, S = 0 < m.vars.itemWidth, x = "fade" === m.vars.animation, w = "" !== m.vars.asNavFor, b = {};
        ...
        b = {
            init: function() {
                ...
                m.transitions = !m.vars.video && !x && m.vars.useCSS && function() {
                    ...
                    for (var a in t)
                        if (void 0 !== e.style[t[a]])
                            return m.pfx = t[a].replace("Perspective", "").toLowerCase(),
                            m.prop = "-" + m.pfx + "-transform",
                            !0;
                    return !1
                }(),
                (m.ensureAnimationEnd = "") !== m.vars.controlsContainer && (m.controlsContainer = 0 < T(m.vars.controlsContainer).length && T(m.vars.controlsContainer)),
                "" !== m.vars.manualControls && (m.manualControls = 0 < T(m.vars.manualControls).length && T(m.vars.manualControls)),
                "" !== m.vars.customDirectionNav && (m.customDirectionNav = 2 === T(m.vars.customDirectionNav).length && T(m.vars.customDirectionNav)),
                ...
                m.vars.keyboard && (1 === T(m.containerSelector).length || m.vars.multipleKeyboard) && T(document).bind("keyup", function(e) {
                    var t = e.keyCode;
                ...
                m.vars.slideshow && m.vars.pauseInvisible && b.pauseInvisible.init(),
                m.vars.slideshow && (m.vars.pauseOnHover && m.hover(function() {
                    m.manualPlay || m.manualPause || m.pause()
                }, function() {
                    m.manualPause || m.manualPlay || m.stopped || m.play()
                }),
                m.vars.pauseInvisible && b.pauseInvisible.isHidden() || (0 < m.vars.initDelay ? m.startTimeout = setTimeout(m.play, m.vars.initDelay) : m.play())),
                w && b.asNav.setup(),
                g && m.vars.touch && b.touch(),
                (!x || x && m.vars.smoothHeight) && T(window).bind("resize orientationchange focus gdlr-core-element-resize", b.resize),
            ...
            asNav: {
                setup: function() {
                    ...
                    m.slides.removeClass(v + "active-slide").eq(m.currentItem).addClass(v + "active-slide"),
                    f ? (p._slider = m).slides.each(function() {
                        ...
                        e.addEventListener("MSGestureTap", function(e) {
                            ...
                            var t = T(this)
                              , a = t.index();
                            T(m.vars.asNavFor).data("goodlayers_flexslider").animating || t.hasClass("active") || (m.direction = m.currentItem < a ? "next" : "prev",
                        ...
                        var t = T(this)
                          , a = t.index();
                        t.offset().left - T(m).scrollLeft() <= 0 && t.hasClass(v + "active-slide") ? m.flexAnimate(m.getTarget("prev"), !0) : T(m.vars.asNavFor).data("goodlayers_flexslider").animating || t.hasClass(v + "active-slide") || (m.direction = m.currentItem < a ? "next" : "prev",
                        m.flexAnimate(a, m.vars.pauseOnAction, !1, !0, !0))
                    })
                }
            },
            controlNav: {
                ...
                setupPaging: function() {
                    ...
                    if (m.controlNavScaffold = T('<ol class="' + v + "control-nav " + v + a + '"></ol>'),
                    1 < m.pagingCount)
                        for (var i = 0; i < m.pagingCount; i++) {
                            if (void 0 === (t = m.slides.eq(i)).attr("data-thumb-alt") && t.attr("data-thumb-alt", ""),
                            altText = "" !== t.attr("data-thumb-alt") ? altText = ' alt="' + t.attr("data-thumb-alt") + '"' : "",
                            e = "thumbnails" === m.vars.controlNav ? '<img src="' + t.attr("data-thumb") + '"' + altText + "/>" : '<a href="#">' + n + "</a>",
                            ...
                            m.controlNavScaffold.append("<li>" + e + "</li>"),
                            n++
                        }
                    m.controlsContainer ? T(m.controlsContainer).append(m.controlNavScaffold) : m.append(m.controlNavScaffold),
                    b.controlNav.set(),
                    b.controlNav.active(),
                    m.controlNavScaffold.delegate("a, img", r, function(e) {
                        ...
                        "" === o || o === e.type) {
                            ...
                            t.hasClass(v + "active") || (m.direction = a > m.currentSlide ? "next" : "prev",
                            m.flexAnimate(a, m.vars.pauseOnAction))
                        }
                        "" === o && (o = e.type),
                ...
                setupManual: function() {
                    ...
                    m.controlNav.bind(r, function(e) {
                        ...
                        "" === o || o === e.type) {
                            var t = T(this)
                              , a = m.controlNav.index(t);
                            t.hasClass(v + "active") || (a > m.currentSlide ? m.direction = "next" : m.direction = "prev",
                            m.flexAnimate(a, m.vars.pauseOnAction))
                        }
                        "" === o && (o = e.type),
                        b.setToClearWatchedEvent()
                ...
                update: function(e, t) {
                    1 < m.pagingCount && "add" === e ? m.controlNavScaffold.append(T('<li><a href="#">' + m.count + "</a></li>")) : 1 === m.pagingCount ? m.controlNavScaffold.find("li").remove() : m.controlNav.eq(t).closest("li").remove(),
                    b.controlNav.set(),
                    1 < m.pagingCount && m.pagingCount !== m.controlNav.length ? m.update(t, e) : b.controlNav.active()
                }
            },
            directionNav: {
                setup: function() {
                    ...
                    m.customDirectionNav ? m.directionNav = m.customDirectionNav : m.controlsContainer ? (T(m.controlsContainer).append(e),
                    m.directionNav = T("." + v + "direction-nav li a", m.controlsContainer)) : (m.append(e),
                    m.directionNav = T("." + v + "direction-nav li a", m)),
                    b.directionNav.update(),
                    m.directionNav.bind(r, function(e) {
                        var t;
                        e.preventDefault(),
                        "" !== o && o !== e.type || (t = T(this).hasClass(v + "next") ? m.getTarget("next") : m.getTarget("prev"),
            ...
            pausePlay: {
                setup: function() {
                    ...
                    m.pausePlay = T("." + v + "pauseplay a", m.controlsContainer)) : (m.append(e),
                    m.pausePlay = T("." + v + "pauseplay a", m)),
                    b.pausePlay.update(m.vars.slideshow ? v + "pause" : v + "play"),
                    m.pausePlay.bind(r, function(e) {
                        e.preventDefault(),
                        "" !== o && o !== e.type || (T(this).hasClass(v + "pause") ? (m.manualPause = !0,
                        m.manualPlay = !1,
            ...
            touch: function() {
                var i, s, r, o, l, d, e, n, c, u = !1, t = 0, a = 0, v = 0;
                if (f) {
                    ...
                    (p._gesture.target = p).addEventListener("MSPointerDown", function(e) {
                        ...
                        o = h ? m.h : m.w,
                        d = Number(new Date),
                        r = S && y && m.animatingTo === m.last ? 0 : S && y ? m.limit - (m.itemW + m.vars.itemMargin) * m.move * m.animatingTo : S && m.currentSlide === m.last ? m.limit : S ? (m.itemW + m.vars.itemMargin) * m.move * m.currentSlide : y ? (m.last - m.currentSlide + m.cloneOffset) * o : (m.currentSlide + m.cloneOffset) * o)
                    }, !1),
                    p._slider = m,
                    p.addEventListener("MSGestureChange", function(e) {
                        ...
                        var a = -e.translationX
                          , n = -e.translationY;
                        if (l = v += h ? n : a,
                        u = h ? Math.abs(v) < Math.abs(-a) : Math.abs(v) < Math.abs(-n),
                        e.detail === e.MSGESTURE_FLAG_INERTIA)
                            return void setImmediate(function() {
                                p._gesture.stop()
                            });
                        (!u || 500 < Number(new Date) - d) && (e.preventDefault(),
                        !x && t.transitions && (t.vars.animationLoop || (l = v / (0 === t.currentSlide && v < 0 || t.currentSlide === t.last && 0 < v ? Math.abs(v) / o + 2 : 1)),
                    ...
                    e = function(e) {
                        m.animating ? e.preventDefault() : !window.navigator.msPointerEnabled && 1 !== e.touches.length || (m.pause(),
                        o = h ? m.h : m.w,
                        d = Number(new Date),
                        t = e.touches[0].pageX,
                        a = e.touches[0].pageY,
                    ...
                    n = function(e) {
                        ...
                        a = e.touches[0].pageY,
                        l = h ? i - a : i - t;
                        (!(u = h ? Math.abs(l) < Math.abs(t - s) : Math.abs(l) < Math.abs(a - s)) || 500 < Number(new Date) - d) && (e.preventDefault(),
                        !x && m.transitions && (m.vars.animationLoop || (l /= 0 === m.currentSlide && l < 0 || m.currentSlide === m.last && 0 < l ? Math.abs(l) / o + 2 : 1),
                        m.setProps(r + l, "setTouch")))
                    }
                    ,
                    c = function(e) {
                        if (p.removeEventListener("touchmove", n, !1),
            ...
            resize: function() {
                ...
                x ? b.smoothHeight() : S ? (m.slides.width(m.computedW),
                m.update(m.pagingCount),
                m.setProps()) : h ? (m.viewport.height(m.h),
                m.setProps(m.h, "setTotal")) : (m.vars.smoothHeight && b.smoothHeight(),
        ...
        m.flexAnimate = function(e, t, a, n, s) {
            ...
            w && 1 === m.pagingCount && (m.direction = m.currentItem < e ? "next" : "prev"),
            !m.animating && (m.canAdvance(e, s) || a) && m.is(":visible")) {
                if (w && n) {
                    ...
                    Math.ceil((e + 1) / m.visible) - 1 === m.currentSlide || 0 === e)
                        ...
                        m.slides.removeClass(v + "active-slide").eq(e).addClass(v + "active-slide"),
                        !1;
                    m.currentItem = e,
                    m.slides.removeClass(v + "active-slide").eq(e).addClass(v + "active-slide"),
                ...
                S) {
                    ...
                    m.slides.removeClass(v + "active-slide").eq(o).each(function() {
                        var e = T(this)
                          , t = m.showItems;
                        for (i = 1; i <= t; i++)
                            e.addClass(v + "active-slide"),
                            e = e.next()
                    })
                } else
                    m.slides.removeClass(v + "active-slide").eq(e).addClass(v + "active-slide");
                if (m.atEnd = 0 === e || e === m.last,
                m.vars.directionNav && b.directionNav.update(),
                e === m.last && (m.vars.end(m),
                m.vars.animationLoop || m.pause()),
                x)
                    g ? (m.slides.eq(m.currentSlide).css({
                        opacity: 0,
                        zIndex: 1
                    }),
                    m.slides.eq(e).css({
                    ...
                    d = S ? (l = m.vars.itemMargin,
                    (c = (m.itemW + l) * m.move * m.animatingTo) > m.limit && 1 !== m.visible ? m.limit : c) : 0 === m.currentSlide && e === m.count - 1 && m.vars.animationLoop && "next" !== m.direction ? y ? (m.count + m.cloneOffset) * u : 0 : m.currentSlide === m.last && 0 === e && m.vars.animationLoop && "prev" !== m.direction ? y ? 0 : (m.count + 1) * u : y ? (m.count - 1 - e + m.cloneOffset) * u : (e + m.cloneOffset) * u,
        ...
        m.setProps = function(e, t, a) {
            var n, i = (n = e || (m.itemW + m.vars.itemMargin) * m.move * m.animatingTo,
            -1 * function() {
                if (S)
                    return "setTouch" === t ? e : y && m.animatingTo === m.last ? 0 : y ? m.limit - (m.itemW + m.vars.itemMargin) * m.move * m.animatingTo : m.animatingTo === m.last ? m.limit : n;
                switch (t) {
                case "setTotal":
            ...
            m.transitions && (i = h ? "translate3d(0," + i + ",0)" : "translate3d(" + i + ",0,0)",
        ...
        m.setup = function(e) {
            ...
            m.vars.smoothHeight && b.smoothHeight()) : ("init" === e && (m.viewport = T('<div class="' + v + 'viewport"></div>').css({
                overflow: "hidden",
                position: "relative"
            }).appendTo(m).append(m.container),
            m.cloneCount = 0,
            m.cloneOffset = 0,
            y && (a = T.makeArray(m.slides).reverse(),
            m.slides = T(a),
            m.container.empty().append(m.slides))),
            m.vars.animationLoop && !S && (m.cloneCount = 2,
            m.cloneOffset = 1,
            "init" !== e && m.container.find(".clone").remove(),
            m.container.append(b.uniqueID(m.slides.first().clone().addClass("clone")).attr("aria-hidden", "true")).prepend(b.uniqueID(m.slides.last().clone().addClass("clone")).attr("aria-hidden", "true"))),
            m.newSlides = T(m.vars.selector, m),
            t = y ? m.count - 1 - m.currentSlide + m.cloneOffset : m.currentSlide + m.cloneOffset,
            h && !S ? (m.container.height(200 * (m.count + m.cloneCount) + "%").css("position", "absolute").width("100%"),
            setTimeout(function() {
                m.newSlides.css({
                    display: "block"
                }),
            ...
            S ? (m.slides.addClass(v + "with-active-class"),
            m.slides.removeClass(v + "active-slide").eq(m.currentSlide).each(function() {
                var e = T(this)
                  , t = m.showItems;
                for (i = 1; i <= t; i++)
                    e.addClass(v + "active-slide"),
                    e = e.next()
            })) : m.slides.removeClass(v + "active-slide").eq(m.currentSlide).addClass(v + "active-slide"),
            m.vars.init(m)
        }
        ,
        m.doMath = function() {
            var e = m.slides.first()
              ...
              , a = m.vars.minItems
              , n = m.vars.maxItems;
            "function" == typeof window.matchMedia ? (window.matchMedia("(max-width: 767px)").matches && (n = a = 1),
            window.matchMedia("(max-width: 419px)").matches && (n = a = 1)) : (T(window).innerWidth() < 767 && (n = a = 1),
        ...
        m.update = function(e, t) {
            ...
            m.animatingTo = m.currentSlide),
            m.vars.controlNav && !m.manualControls && ("add" === t && !S || m.pagingCount > m.controlNav.length ? b.controlNav.update("add") : ("remove" === t && !S || m.pagingCount < m.controlNav.length) && (S && m.currentSlide > m.last && (--m.currentSlide,
            --m.animatingTo),
        ...
        m.addSlide = function(e, t) {
            ...
            m.count += 1,
            m.last = m.count - 1,
            h && y ? void 0 !== t ? m.slides.eq(m.count - t).after(a) : m.container.prepend(a) : void 0 !== t ? m.slides.eq(t).before(a) : m.container.append(a),
            m.update(t, "add"),
        ...
        m.removeSlide = function(e) {
            ...
            --m.count,
            m.last = m.count - 1,
            isNaN(e) ? T(e, m.slides).remove() : h && y ? m.slides.eq(m.last).remove() : m.slides.eq(e).remove(),
            m.doMath(),
            m.update(t, "remove"),
            m.slides = T(m.vars.selector + ":not(.clone)", m),
            m.setup(),
        ...
        "object" == typeof n)
            return this.each(function() {
                var e = T(this)
                  ...
                  , a = e.find(t);
                1 === a.length && !0 === n.allowOneSlide || 0 === a.length ? (a.fadeIn(400),
                n.start && n.start(e)) : void 0 === e.data("goodlayers_flexslider") && new T.goodlayers_flexslider(this,n)
            });
...
!function(Te, e, ke) {
    "use strict";
    var xe, De, Ae, Ee = "sly", qe = e.cancelAnimationFrame || e.cancelRequestAnimationFrame, Oe = e.requestAnimationFrame, Ne = Te(document), He = "touchstart." + Ee + " mousedown." + Ee, Xe = "mousemove." + Ee + " mouseup." + Ee, Ye = "touchmove." + Ee + " touchend." + Ee, Me = (document.implementation.hasFeature("Event.wheel", "3.0") ? "wheel." : "mousewheel.") + Ee, je = "click." + Ee, Fe = "mousedown." + Ee, Le = ["INPUT", "SELECT", "BUTTON", "TEXTAREA"], Re = [], We = Math.abs, Ue = Math.sqrt, $e = Math.pow, Qe = Math.round, Ze = Math.max, Ge = Math.min, Je = 0;
    function Ke(o, e, n) {
        if (!(this instanceof Ke))
            return new Ke(o,e,n);
        var a, i, g = Te.extend({}, Ke.defaults, e), l = this, m = at(o), c = Te(o), y = g.slidee ? Te(g.slidee).eq(0) : c.children().eq(0), w = 0, I = 0, b = {
            start: 0,
            center: 0,
            end: 0,
            cur: 0,
            dest: 0
        }, P = Te(g.scrollBar).eq(0), z = P.children().eq(0), C = 0, S = 0, B = {
            start: 0,
            end: 0,
            cur: 0
        }, T = Te(g.pagesBar), k = 0, x = [], D = 0, A = [], E = {
            firstItem: 0,
            lastItem: 0,
            centerItem: 0,
            activeItem: null,
            activePage: 0
        }, r = new rt(c[0]), s = new rt(y[0]), d = new rt(P[0]), u = new rt(z[0]), t = "basic" === g.itemNav, q = "forceCentered" === g.itemNav, O = "centered" === g.itemNav || q, N = !m && (t || O || q), f = g.scrollSource ? Te(g.scrollSource) : c, v = g.dragSource ? Te(g.dragSource) : c, h = Te(g.forward), p = Te(g.backward), H = Te(g.prev), X = Te(g.next), Y = Te(g.prevPage), M = Te(g.nextPage), j = {}, F = {}, L = {}, R = {}, W = {
            released: 1
        }, U = {
            last: 0,
            delta: 0,
        ...
        function J(e) {
            ...
            N) {
                A.length,
                D = y.children(g.itemSelector),
                A.length = 0;
                var d, u = nt(y, g.horizontal ? "paddingLeft" : "paddingTop"), f = nt(y, g.horizontal ? "paddingRight" : "paddingBottom"), a = "border-box" === Te(D).css("boxSizing"), v = "none" !== D.css("float"), h = 0, p = D.length - 1;
                I = 0,
                D.each(function(e, t) {
                    var a = Te(t)
                ...
                y[0].style[g.horizontal ? "width" : "height"] = (a ? I : I - u - f) + y.children().length + "px",
                I -= h,
                A.length ? (b.start = A[0][q ? "center" : "start"],
                b.end = q ? d.center : w < I ? d.end : b.start) : b.start = b.end = 0
            }
            if (b.center = Qe(b.end / 2 + b.start / 2),
            se(),
            z.length && 0 < C && (g.dynamicHandle ? (S = it(S = b.start === b.end ? C : Qe(C * w / I), g.minHandleSize, C),
            z[0].style[g.horizontal ? "width" : "height"] = S + "px") : S = z[g.horizontal ? "outerWidth" : "outerHeight"](),
            B.end = C - S,
            $ || _()),
            !m && 0 < w) {
                var n = b.start
                ...
                if (N)
                    Te.each(A, function(e, t) {
                        q ? x.push(t.center) : t.start + t.size > n && n <= b.end && (n = t.start,
                        x.push(n),
        ...
        function K(e, t, a) {
            if (N && W.released && !a) {
                var n = re(e)
                  , i = e > b.start && e < b.end;
                O ? (i && (e = A[n.centerItem].center),
                q && g.activateMiddle && ie(n.centerItem)) : i && (e = A[n.firstItem].start)
            }
            W.init && W.slidee && g.elasticBounds ? e > b.end ? e = b.end + (e - b.end) / 6 : e < b.start && (e = b.start + (e - b.start) / 6) : e = it(e, b.start, b.end),
            L.start = +new Date,
            L.time = 0,
            L.from = b.cur,
            L.to = e,
            ...
            se(),
            oe(),
            k[0] && F.page !== E.activePage && (F.page = E.activePage,
        ...
        function V() {
            if (l.initialized) {
                if (!$)
                    return $ = Oe(V),
                    void (W.released && Be("moveStart"));
                L.immediate ? b.cur = L.to : L.tweesing ? (L.tweeseDelta = L.to - b.cur,
                We(L.tweeseDelta) < .1 ? b.cur = L.to : b.cur += L.tweeseDelta * (W.released ? g.swingSpeed : g.syncSpeed)) : (L.time = Ge(+new Date - L.start, g.speed),
                b.cur = L.from + L.delta * Te.easing[g.easing](L.time / g.speed, L.time, 0, 1, g.speed)),
                L.to === b.cur ? (b.cur = L.to,
                W.tweese = $ = 0) : $ = Oe(V),
                Be("move"),
                m || (xe ? y[0].style[xe] = De + (g.horizontal ? "translateX" : "translateY") + "(" + -b.cur + "px)" : y[0].style[g.horizontal ? "left" : "top"] = -Qe(b.cur) + "px"),
                !$ && W.released && Be("moveEnd"),
                _()
            }
        }
        function _() {
            z.length && (B.cur = b.start === b.end ? 0 : ((W.init && !W.slidee ? b.dest : b.cur) - b.start) / (b.end - b.start) * B.end,
            B.cur = it(Qe(B.cur), B.start, B.end),
            F.hPos !== B.cur && (F.hPos = B.cur,
            xe ? z[0].style[xe] = De + (g.horizontal ? "translateX" : "translateY") + "(" + B.cur + "px)" : z[0].style[g.horizontal ? "left" : "top"] = B.cur + "px"))
        }
        function ee() {
        ...
        function ie(e, t) {
            var a = ae(e);
            return !(!N || a < 0) && ((F.active !== a || t) && (D.eq(E.activeItem).removeClass(g.activeClass),
        ...
        function re(e) {
            ...
            if (N) {
                for (var r = !1, s = !1, o = !1, l = 0, c = A.length; l < c; l++)
                    if (!1 === r && e <= A[l].start + A[l].half && (r = l),
        ...
        function oe() {
            var e = b.dest <= b.start
              , t = b.dest >= b.end
              , a = (e ? 1 : 0) | (t ? 2 : 0);
            if (F.slideePosState !== a && (F.slideePosState = a,
            ...
            F.fwdbwdState !== a && W.released && (F.fwdbwdState = a,
            ...
            N && null != E.activeItem) {
                var n = 0 === E.activeItem
                  ...
                  , r = (n ? 1 : 0) | (i ? 2 : 0);
                F.itemsButtonState !== r && (F.itemsButtonState = r,
        ...
        function le(e, t, a) {
            if (e = ne(e),
            t = ne(t),
            -1 < e && -1 < t && e !== t && (!a || t !== e - 1) && (a || t !== e + 1)) {
                D.eq(e)[a ? "insertAfter" : "insertBefore"](A[t].el);
                var n = e < t ? e : a ? t : t - 1
                  , i = t < e ? e : a ? t + 1 : t
                  , r = t < e;
                null != E.activeItem && (e === E.activeItem ? F.active = E.activeItem = a ? r ? t + 1 : t : r ? t : t - 1 : E.activeItem > n && E.activeItem < i && (F.active = E.activeItem += r ? 1 : -1)),
                J()
            }
        }
        function ce(e, t) {
        ...
        function he(e) {
            var t = "touchstart" === e.type
              , a = e.data.source
              , n = "slidee" === a;
            W.init || !t && me(e.target) || ("handle" !== a || g.dragHandle && B.start !== B.end) && (n && !(t ? g.touchDragging : g.mouseDragging && e.which < 2) || (t || _e(e),
            ve(a),
            W.init = 0,
        ...
        function pe(e) {
            if (W.released = "mouseup" === e.type || "touchend" === e.type,
            W.pointer = W.touch ? e.originalEvent[W.released ? "changedTouches" : "touches"][0] : e,
            ...
            W.released || !(W.path < 1)) {
                if (!W.init) {
                    if (W.path < g.dragThreshold)
                        return W.released ? ge() : ke;
                    if (!(g.horizontal ? We(W.pathX) > We(W.pathY) : We(W.pathX) < We(W.pathY)))
                        return ge();
                    W.init = 1
                }
                _e(e),
                !W.locked && W.path > W.pathToLock && W.slidee && (W.locked = 1,
                W.$source.on(je, et)),
                W.released && (ge(),
                g.releaseSwing && W.slidee && (W.swing = (W.delta - W.history[0]) / 40 * 300,
                W.delta += W.swing,
        ...
        function we(e) {
            ...
            case h[0]:
            case p[0]:
                l.moveBy(h.is(this) ? g.moveBy : -g.moveBy),
                Ne.on("mouseup", ye);
                break;
            case H[0]:
                l.prev();
        ...
        function Ie(e) {
            ...
            if (Je + g.scrollHijack > t && f[0] !== document && f[0] !== window)
                ...
                var a, n = (a = e.originalEvent,
                U.curDelta = (g.horizontal ? a.deltaY || a.deltaX : a.deltaY) || -a.wheelDelta,
                U.curDelta /= 1 === a.deltaMode ? 3 : 100,
                N ? (Ae = +new Date,
                U.last < Ae - U.resetTime && (U.delta = 0),
                U.last = Ae,
                U.delta += U.curDelta,
                We(U.delta) < 1 ? U.finalDelta = 0 : (U.finalDelta = Qe(U.delta / 1),
                U.delta %= 1),
                U.finalDelta) : U.curDelta);
                (g.scrollTrap || 0 < n && b.dest < b.end || n < 0 && b.dest > b.start) && _e(e, 1),
                l.slideBy(g.scrollBy * n)
            }
        }
        function be(e) {
            g.clickBar && e.target === P[0] && (_e(e),
            K(ue((g.horizontal ? e.pageX - P.offset().left : e.pageY - P.offset().top) - S / 2)))
        }
        function Pe(e) {
            if (g.keyboardNavBy)
                switch (e.which) {
                case g.horizontal ? 37 : 38:
                    _e(e),
                    l["pages" === g.keyboardNavBy ? "prevPage" : "prev"]();
                    break;
                case g.horizontal ? 39 : 40:
                    _e(e),
                    l["pages" === g.keyboardNavBy ? "nextPage" : "next"]()
                }
        }
        function ze(e) {
        ...
        l.moveBy = function(e) {
            R.speed = e,
            !W.init && R.speed && b.cur !== (0 < R.speed ? b.end : b.start) && (R.lastTime = +new Date,
            R.startPos = b.cur,
            ve("button"),
            W.init = 1,
            Be("moveStart"),
        ...
        ,
        l.resume = function(e) {
            g.cycleBy && g.cycleInterval && ("items" !== g.cycleBy || A[0] && null != E.activeItem) && !(e < l.isPaused) && (l.isPaused = 0,
        ...
        l.add = function(e, t) {
            var a = Te(e);
            N ? (null == t || !A[0] || t >= A.length ? a.appendTo(y) : A.length && a.insertBefore(A[t].el),
            null != E.activeItem && t <= E.activeItem && (F.active = E.activeItem += a.length)) : y.append(a),
            J()
        }
        ,
        l.remove = function(e) {
            if (N) {
                ...
                if (-1 < t) {
                    ...
                    null != E.activeItem && t < E.activeItem && (F.active = --E.activeItem),
                    J(),
                    a && (F.active = null,
                    l.activate(E.activeItem))
                }
            } else
                Te(e).remove(),
                J()
        ...
        ,
        l.destroy = function() {
            return Ke.removeInstance(o),
            f.add(z).add(P).add(T).add(h).add(p).add(H).add(X).add(Y).add(M).off("." + Ee),
            Ne.off("keydown", Pe),
            H.add(X).add(Y).add(M).removeClass(g.disabledClass),
            D && null != E.activeItem && D.eq(E.activeItem).removeClass(g.activeClass),
            T.empty(),
            m || (c.off("." + Ee),
            r.restore(),
            s.restore(),
        ...
        l.init = function() {
            if (!l.initialized) {
                ...
                xe || "static" !== c.css("position") || c.css("position", "relative")),
                xe ? De && a.css(xe, De) : ("static" === P.css("position") && P.css("position", "relative"),
                a.css({
                    position: "absolute"
                })),
                ...
                T[0] && g.activatePageOn && T.on(g.activatePageOn + "." + Ee, "*", Ce),
                v.on(He, {
                    source: "slidee"
                }, he),
                z && z.on(He, {
                ...
                Ne.on("keydown", Pe),
                m || (c.on("mouseenter." + Ee + " mouseleave." + Ee, Se),
                c.on("scroll." + Ee, tt)),
                l.initialized = 1,
                J(!0),
    ...
    function() {
        ...
        xe = e("transform"),
        De = e("perspective") ? "translateZ(0) " : ""
    }(),
    e.Sly = Ke,
    Te.fn.sly = function(n, i) {
        var r, s;
        return Te.isPlainObject(n) || ("string" !== Ve(n) && !1 !== n || (r = !1 === n ? "destroy" : n,
